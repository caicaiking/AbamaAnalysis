...
void clsStockShow::onComboBoxChanged(int)
{
    drawChart(m_ChartViewer);
}

void clsStockShow::onLineEditChanged()
{
...
bool clsStockShow::getData(const QString &ticker, QDateTime startDate, QDateTime endDate,
...
/// <param name="startDate">The starting date/time for the data series.</param>
/// <param name="endDate">The ending date/time for the data series.</param>
void clsStockShow::get15MinData(const QString &ticker, QDateTime startDate, QDateTime endDate)
{
    //
...
/// <param name="startDate">The starting date/time for the data series.</param>
/// <param name="endDate">The ending date/time for the data series.</param>
void clsStockShow::getWeeklyData(const QString &ticker, QDateTime startDate, QDateTime endDate)
{
    //
    // In this demo, we use a random number generator to generate the data. In practice,
...
/// <param name="startDate">The starting date/time for the data series.</param>
/// <param name="endDate">The ending date/time for the data series.</param>
void clsStockShow::getMonthlyData(const QString &ticker, QDateTime startDate, QDateTime endDate)
{
    //
    // In this demo, we use a random number generator to generate the data. In practice,
...
void clsStockShow::generateRandomData(const QString &ticker, QDateTime startDate,
...
/// </summary>
void clsStockShow::convertDailyToWeeklyData()
{
...
/// </summary>
void clsStockShow::convertDailyToMonthlyData()
{
...
/// </summary>
void clsStockShow::aggregateData(ArrayMath &aggregator)
{
